...
public class QueueProducerSSL {
    ...
    public void run(String... args) throws Exception {
        ...
        String queue_name = "".equals(args[3])?QUEUE_NAME:args[3];
    ...
    public static void main(String... args) throws Exception {
        if (args.length != 4 || args[1].split("@").length != 2) {
            System.out.println("Usage: QueueProducer <host:port> <client-username@message-vpn> <client-password> <queue-name>");
            System.out.println();
            System.exit(-1);
        }
